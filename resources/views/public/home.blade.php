            ...
            <div class="pt-12 md:py-12 px-2 sm:px-5 md:px-10 lg:px-14">
                ...
                <div class="lg:hidden">
                    <div
                        ...
                        <img src="{{ $profile->photo ? asset('storage/' . $profile->photo) : asset('images/LOGO.jpg') }}"
                            class="w-[240px] absolute left-[50%] transform -translate-x-[50%] h-[240px] drop-shadow-xl mx-auto rounded-[20px] -mt-[140px]"
                            alt="about" />
                        <div class="pt-[100px] pb-8">
                            <h2 class="mt-6 mb-1 text-[26px] font-semibold dark:text-white">{{ $profile->name }}</h2>
                            <h3 class="mb-4 text-[#7B7B7B] inline-block dark:bg-[#1D1D1D] px-5 py-1.5 rounded-lg dark:text-[#A6A6A6]">
                                {{ $profile->title }}</h3>
                            <div class="flex justify-center space-x-3">
                                <a href="https://www.facebook.com/" target="_blank" rel="noopener noreferrer">
                                    <span class="socialbtn text-[#1773EA]"><i class="fa-brands fa-facebook-f"></i></span>
                                </a>
                                <a href="https://twitter.com/" target="_blank" rel="noopener noreferrer">
                                    <span class="socialbtn text-[#1C9CEA]"><i class="fa-brands fa-twitter"></i></span>
                                </a>
                                <a href="https://dribbble.com/" target="_blank" rel="noopener noreferrer">
                                    <span class="socialbtn text-[#e14a84]"><i class="fa-brands fa-dribbble"></i></span>
                                </a>
                                <a href="https://www.linkedin.com/" target="_blank" rel="noopener noreferrer">
                                    <span class="socialbtn text-[#0072b1]"><i class="fa-brands fa-linkedin-in"></i></span>
                                </a>
                            </div>
                            <div class="p-7 rounded-2xl mt-7 bg-[#F3F6F6] dark:bg-[#1D1D1D]">
                                <div class="flex border-b border-[#E3E3E3] dark:border-[#3D3A3A] pb-2.5">
                                    ...
                                    <div class="text-left ml-2.5">
                                        ...
                                        <p class="dark:text-white">{{ $profile->phone }}</p>
                                    </div>
                                </div>
                                <div class="flex border-b border-[#E3E3E3] dark:border-[#3D3A3A] py-2.5">
                                    ...
                                    <div class="text-left ml-2.5">
                                        ...
                                        <p class="dark:text-white">{{ $profile->email }}</p>
                                    </div>
                                </div>
                                <div class="flex border-b border-[#E3E3E3] dark:border-[#3D3A3A] py-2.5">
                                    ...
                                    <div class="text-left ml-2.5">
                                        ...
                                        <p class="dark:text-white">{{ $profile->address }}</p>
                                    </div>
                                </div>
                ...
                <div class="grid gap-8 grid-cols-1 md:grid-cols-2 xl:grid-cols-2">
                    <div class="about-box bg-[#fcf4ff] dark:bg-transparent">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]">Creo sitios web usando HTML, CSS, JavaScript y Laravel.</p>
                        </div>
                    </div>
                    ...
                    <div class="about-box bg-[#fefaf0] dark:bg-transparent">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]">Desarrollo aplicaciones web funcionales con tecnologías modernas.</p>
                        </div>
                    </div>
                    ...
                    <div class="about-box bg-[#fcf4ff] dark:bg-transparent">
                        ...
                        <div class="space-y-2">
                            <h3 class="dark:text-white text-[22px] font-semibold">Bases de datos</h3>
                            <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]">Manejo bases de datos MySQL para almacenar y gestionar información.</p>
                        </div>
                    </div>
                    ...
                    <div class="about-box bg-[#fff4f4] dark:bg-transparent">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]">Uso Git y GitHub para gestionar el código de mis proyectos.</p>
                        </div>
                    </div>
                    ...
                    <div class="about-box bg-[#fff0f8] dark:bg-transparent">
                        ...
                        <div class="space-y-2">
                            ...
                            <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]">Diseño interfaces limpias y funcionales para mis proyectos.</p>
                        </div>
                    </div>
                    ...
                    <div class="about-box bg-[#f3faff] dark:bg-transparent">
                        ...
                        <div class="space-y-2">
                            <h3 class="dark:text-white text-[22px] font-semibold">Backend</h3>
                            <p class="leading-8 text-gray-lite dark:text-[#A6A6A6]">Desarrollo la lógica del servidor usando PHP y Laravel.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="px-2 sm:px-5 md:px-10 lg:px-14">
                <div class="bg-[#F8FBFB] dark:bg-[#0D0D0D] max-w-full h-auto py-10 rounded-xl">
                    ...
                    <div class="slickOne text-center px-2 pt-8">
                        <div><img class="overflow-hidden brand-img" src="{{asset('images/slider/brand.png')}}" alt="brand icon" /></div>
                        <div><img class="overflow-hidden brand-img" src="{{asset('images/slider/brand1.png')}}" alt="brand icon" /></div>
                        <div><img class="overflow-hidden brand-img" src="{{asset('images/slider/brand2.png')}}" alt="brand icon" /></div>
                        <div><img class="overflow-hidden brand-img" src="{{asset('images/slider/brand3.png')}}" alt="brand icon" /></div>
                        <div><img class="overflow-hidden brand-img" src="{{asset('images/slider/brand4.png')}}" alt="brand icon" /></div>
                        <div><img class="overflow-hidden brand-img" src="{{asset('images/slider/brand1.png')}}" alt="brand icon" /></div>
                        <div><img class="overflow-hidden brand-img" src="{{asset('images/slider/brand1.png')}}" alt="brand icon" /></div>
                    </div>
                </div>
