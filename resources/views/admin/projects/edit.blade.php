...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .photo-preview { width: 120px; height: 80px; object-fit: cover; border-radius: 8px; border: 1px solid #2d3148; margin-bottom: 8px; display: block; }
        ...
        <form action="{{ route('admin.projects.update', $project) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card">
                ...
                <div class="form-group">
                    <label>Imagen</label>
                    @if($project->image)
                        <img src="{{ asset('storage/' . $project->image) }}" class="photo-preview">
                    @endif
